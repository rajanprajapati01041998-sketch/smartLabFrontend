  ...
  return (
    <ScrollView>
      <View style={[tw`p-4 my-3 rounded-xl`]}>
        ...
        >
          <Text style={styles.patientInfoText}>Patient Details</Text>
        ...
        <View style={tw`mt-6`}>
          <View style={tw`flex-row justify-between mb-2`}>
            <Text style={[styles.patientInfoText]}>Select Test </Text>
            ...
            <View style={[themed.childScreen, tw`rounded-t-3xl h-[65%]`]}>
              <View style={tw`flex-1 px-4 pt-4`}>
                <View style={tw`flex-row justify-between items-center mb-4`}>
                  <Text style={styles.patientInfoText}>Refund Test</Text>
