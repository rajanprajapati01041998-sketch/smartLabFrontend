...
import { allBankList } from '../PatientRegistration/services/doctorService';
import SelectApproval from '../PatientRegistration/SelectApproval';
...
const PaymentDetails = ({ totalAmount, grossAmount, values, onChange }) => {
  ...
  return (
    <View style={[themed.childScreen2, themed.border, tw`p-4`]}>
      <Text style={[styles.patientInfoText, tw`mb-3`]}>Payment Details</Text>
