    ...
    <View style={tw`mt-6 mb-4`}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        {paymentModes.map((item) => {
          ...
          // Show only cash if showAllModes is false, otherwise show all
              ...
              <View style={[tw``, styles.cardShadow]}>
                ...
                <View style={tw`flex-row justify-between items-center mb-3`}>
                  ...
                  {!isCash && (
                    ...
                    >
                      <Icon
                        name={expandedCards[item.paymentModeId] && data.amount > 0 ? 'chevron-up' : 'chevron-down'}
                        size={20}
                        color="#9CA3AF"
                      />
                    </TouchableOpacity>
                ...
                {/* Amount Input */}
                <View style={tw`mb-3`}>
                  <Text style={tw`text-xs text-gray-500 mb-1 ml-1`}>Amount</Text>
                  <View style={[
                ...
                {/* Expanded Fields with Animation */}
                  ...
                  <Animated.View
                    style={[
                      tw`mt-2 pt-2 border-t `,
                      {
                        ...
                        maxHeight: animations.current[item.paymentModeId].interpolate({
                          inputRange: [0, 1],
                          outputRange: [0, 200]
                        })
                      }
                    ...
                    <View style={tw`flex flex-row gap-2`}>
                      ...
                      {item.payModeType === "Bank Payment" && (
                        <View style={tw`mb-3 flex-1`}>
                          <Text style={tw`text-xs text-gray-500 mb-1 ml-1`}>Select Bank</Text>
                          <TouchableOpacity
                            onPress={() => {
                      ...
                      {/* Reference Input */}
                      <View style={tw`flex-1`}>
                        <Text style={tw`text-xs text-gray-500 mb-1 ml-1`}>Reference / Transaction ID</Text>
                        <View style={[
                          tw`flex-row items-center border rounded-xl px-3`,
                          { borderColor: '#E5E7EB', backgroundColor: '#F9FAFB' }
                        ]}>
          ...
          <View style={tw`flex-1 justify-end bg-black/50`}>
            <View style={tw`bg-white rounded-t-3xl  `}>
              <View style={tw`p-4  flex-row justify-between items-center`}>
                <Text style={tw`text-lg font-semibold text-gray-800`}>Select Bank</Text>
