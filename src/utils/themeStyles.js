...
export const getThemeStyles = theme => {
  ...
  return {
    ...
    normalText: tw.style(isDark ? 'text-white' : 'text-gray-800'),
    ...
    modalCard: tw.style('overflow-hidden', isDark ? 'bg-gray-800' : 'bg-white'),
    ...
    // Divider / labels
    globalDivider: tw.style('border-gray-700', !isDark && 'border-gray-200'),
    ...
    listItemIconWrap: isSelected =>
      tw.style(
        'p-2 rounded-lg mr-3',
        isSelected ? 'bg-blue-100' : isDark ? 'bg-gray-700' : 'bg-gray-100',
      ),
    ...
    saveButtonText: tw.style('text-center font-medium text-white'),
    ...
    primaryButton: tw.style('py-3 rounded-xl bg-blue-500'),

    primaryButtonText: tw.style('text-center font-semibold text-white'),
    ...
    // ✅ Search Button Text
    searchButtonText: tw.style('text-white text-sm font-semibold'),
